...
test('the page lists every organization', function (): void {
    Organization::factory()->createOne([Organizations::name->value => 'Acme Inc.']);
    Organization::factory()->createOne([Organizations::name->value => 'Globex Corp.']);
...
test('an organization is created', function (): void {
    $this->actingAs(User::factory()->createOne())
