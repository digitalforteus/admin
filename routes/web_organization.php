...
Route::post(OrganizationRoute::projects->value, ProjectController::class);
Route::post(OrganizationRoute::projectSettings->value, ProjectUpdateController::class);
Route::delete(OrganizationRoute::projectSettings->value, ProjectDestroyController::class);
Route::post(OrganizationRoute::projectIcon->value, ProjectIconController::class);
Route::delete(OrganizationRoute::projectIcon->value, ProjectIconDestroyController::class);
